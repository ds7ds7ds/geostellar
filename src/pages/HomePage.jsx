...
const HomePage = () => {
  const capabilities = [
    ...
    },
    {
      ...
      description: "Data-driven optimization with real-time monitoring and verification"
    },
    {
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl md:text-7xl font-light text-white leading-tight mb-6">
              Oil & Gas Precision.
              <br />
              <span className="gradient-text font-semibold">Geothermal Future.</span>
            </h1>
            
            <p className="text-xl text-slate-400 leading-relaxed mb-8 max-w-2xl">
              We bring the rigorous standards and technical excellence of the oil & gas industry 
              to shallow geothermal engineering. Because sustainable energy deserves precision.
            </p>

            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/services"
                className="inline-flex items-center justify-center px-6 py-3 bg-sky-500 hover:bg-sky-400 text-slate-900 font-medium rounded transition-all hover:shadow-lg hover:shadow-sky-500/25"
              >
                Explore Services
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {capabilities.map((cap, index) => (
              <div
                key={index}
                className="group p-6 bg-slate-900/50 border border-slate-800 rounded-lg hover:border-sky-500/50 transition-all hover:bg-slate-900"
              >
                <div className="text-sky-500 mb-4 group-hover:text-cyan-400 transition-colors">
                  {cap.icon}
                </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center">
                <div className="text-4xl md:text-5xl font-light text-sky-400 mb-2">
                  {stat.value}
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {sectors.map((sector, index) => (
                <div
                  key={index}
                  className="p-8 bg-slate-900 border border-slate-800 rounded-lg text-center hover:border-sky-500/50 transition-colors"
                >
